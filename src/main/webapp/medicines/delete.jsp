      ...
      <table class="table table-bordered">
        ...
        <c:forEach var="item" items="${medicines}">
          <tr>
            ...
            <td>
              <a href="${pageContext.request.contextPath}/medicines?action=edit&idEdit=${item.id_medicine}" class="me-2">
                <i class="fa-solid fa-pen-to-square"></i>
              </a>
              <a href="${pageContext.request.contextPath}/medicines?action=delete&idDelete=${item.id_medicine}">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="deleteLabel">Xác nhận xóa thuốc</h5>
              <a href="${pageContext.request.contextPath}/medicines?action=home" class="btn-close"></a>
            </div>
            <div class="modal-body">
              <p>Bạn có chắc muốn xóa thuốc
                <strong><c:out value="${medicineDelete != null ? medicineDelete.medicine_name : '---'}"/></strong>
                (Mã: <c:out value="${medicineDelete != null ? medicineDelete.id_medicine : '---'}"/>)?
              </p>
            </div>
            <div class="modal-footer">
              <a href="${pageContext.request.contextPath}/medicines?action=home" class="btn btn-secondary">Quay lại</a>

              <form id="deleteForm" action="${pageContext.request.contextPath}/medicines?action=delete" method="post" style="display:inline;">
                <input type="hidden" name="id_medicine" value="<c:out value='${medicineDelete != null ? medicineDelete.id_medicine : ""}'/>" />
