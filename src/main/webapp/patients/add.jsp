    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="/patients?action=add" method="post">
                <input type="text" placeholder="Tên Bệnh Nhân" name="name">
                <input type="date" placeholder="Ngày Sinh" name="birth_date">
                <select id="gender-select" name="gender">
                    <option value="Nam">Nam</option>
                    <option value="Nu">Nu</option>
                </select>
                <input type="tel" placeholder="Điện Thoại" name="phone">
                <input type="tel" placeholder="Địa Chỉ" name="address">
