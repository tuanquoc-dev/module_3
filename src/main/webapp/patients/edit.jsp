...
<div class="container-fluid">
  <div class="row flex-nowrap">
    ...
    <div class="col py-3">
      <h3>Sửa Bệnh Nhân</h3>
      <form action="/patients?action=edit" method="post">
        <input type="number" placeholder="Id" name="id_patient" value="${patientEdit.id_patient}" readonly>
        <input type="text" placeholder="Tên Bệnh Nhân" name="name" value="${patientEdit.name}">
        <input type="date" placeholder="Ngày Sinh" name="birth_date" value="${patientEdit.birth_date}">
        <select id="gender-select" name="gender">
          <option value="Nam" <c:if test="${patientEdit.gender == 'Nam'}"></c:if>>Nam</option>
          <option value="Nu" <c:if test="${patientEdit.gender == 'Nu'}"></c:if>>Nữ</option>
        </select>
        <input type="tel" placeholder="Điện Thoại" name="phone" value="${patientEdit.phone}">
        <input type="tel" placeholder="Địa Chỉ" name="address" value="${patientEdit.address}">
