...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="/appointments?action=add" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" id="status" class="form-select">
                        <option value="Đã Xác Nhận"><c:out value="Đã Xác Nhận"/></option>
                        <option value="Chưa Xác Nhận"><c:out value="Chưa Xác Nhận"/></option>
                        <option value="Đã hủy"><c:out value="Đã hủy"/></option>
                    </select>
                </div>
