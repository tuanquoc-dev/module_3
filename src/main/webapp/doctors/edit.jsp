...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h3>Sửa Bác Sĩ</h3>
            <form action="/doctors?action=edit" method="post">
                <input type="number" placeholder="Id" name="id_doctor" value="${doctorEdit.id_doctor}" readonly>
                <input type="text" placeholder="Tên Bác Sĩ" name="name" value="${doctorEdit.name}">
                <input type="text" placeholder="Chuyên Khoa" name="specialty" value="${doctorEdit.specialty}">
                <input type="text" placeholder="Trình Dộ Chuyên Môn" name="qualification" value="${doctorEdit.qualification}">
                <input type="tel" placeholder="Điện Thoại" name="phone" value="${doctorEdit.phone}">
