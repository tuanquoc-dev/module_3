...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="/medicalRecords?action=add" method="post">
                <div class="mb-3">
                    <label for="exam_date" class="form-label">Ngày Khám Bệnh</label>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_appointment" id="id_appointment" class="form-select" required>
                        <c:forEach var="item" items="${appointments}">
                            <option value="${item.id_appointment}">${item.appointment_date}</option>
                        </c:forEach>
                    </select>
                </div>
