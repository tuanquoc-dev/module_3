...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="/prescriptions?action=add" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="id_medical_record" class="form-label">Ngày Kiểm Tra</label>
                    <select name="id_medical_record" id="id_medical_record" class="form-select" required>
                        <c:forEach var="item" items="${medicalRecords}">
                            <option value="${item.id_medical_record}">${item.exam_date}</option>
                        </c:forEach>
                    </select>
                </div>
